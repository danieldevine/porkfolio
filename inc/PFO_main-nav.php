<div class="nav-collapse" id="nave">
  ...
  <ul class="main-nav">
    ...
    <li>
      <div class="contact-details-wrap">
        <ul id="contact-details">
          ...
          <li><i class="fa fa-bookmark fa-1x"></i> &nbsp; Ardpatrick,<br />Co. Limerick, Ireland</li>
        </ul>
      </div>
    </li>
    ...
    <li>
      <ul id="social-nav">
        <li><a href="mailto:dan@blackroad.ie">                             <i class="fa fa-envelope fa-1x"></i></a> </li>
